...
public class BuddingdarkrotBlock extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:buddingdarkrot")
	public static final Block block = null;
	public BuddingdarkrotBlock(VanillaAdditionsByTrappModElements instance) {
		super(instance, 211);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("buddingdarkrot");
		}
