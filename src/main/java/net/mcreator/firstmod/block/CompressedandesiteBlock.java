...
public class CompressedandesiteBlock extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:compressedandesite")
	public static final Block block = null;
	public CompressedandesiteBlock(VanillaAdditionsByTrappModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("compressedandesite");
		}
