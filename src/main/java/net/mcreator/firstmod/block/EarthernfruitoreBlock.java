...
import net.mcreator.firstmod.item.EarthernfruitItem;
...
public class EarthernfruitoreBlock extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:earthernfruitore")
	public static final Block block = null;
	public EarthernfruitoreBlock(VanillaAdditionsByTrappModElements instance) {
		super(instance, 207);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.9000000000000001f, 10f)
					.setLightLevel(s -> 0));
			setRegistryName("earthernfruitore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EarthernfruitItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("vanilla_additions_by_trapp:earthernfruitore_match"),
