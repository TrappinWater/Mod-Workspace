...
import net.mcreator.firstmod.item.ElectrociteItem;
...
public class ElectrociteoreBlock extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:electrociteore")
	public static final Block block = null;
	public ElectrociteoreBlock(VanillaAdditionsByTrappModElements instance) {
		super(instance, 245);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(2f, 21f).setLightLevel(s -> 15));
			setRegistryName("electrociteore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ElectrociteItem.block));
		}
	}
	...
	private static class CustomRuleTest extends RuleTest {
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			if (blockAt.getBlock() == Blocks.CAVE_AIR)
				blockCriteria = true;
			if (blockAt.getBlock() == ElectrolyticfluidBlock.block)
				blockCriteria = true;
			if (blockAt.getBlock() == Blocks.REDSTONE_BLOCK)
				blockCriteria = true;
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("vanilla_additions_by_trapp:electrociteore_match"),
