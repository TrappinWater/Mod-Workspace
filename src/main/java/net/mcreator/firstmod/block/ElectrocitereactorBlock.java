...
public class ElectrocitereactorBlock extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:electrocitereactor")
	public static final Block block = null;
	public ElectrocitereactorBlock(VanillaAdditionsByTrappModElements instance) {
		super(instance, 296);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("electrocitereactor");
		}
