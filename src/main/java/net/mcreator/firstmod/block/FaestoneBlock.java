...
public class FaestoneBlock extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:faestone")
	public static final Block block = null;
	public FaestoneBlock(VanillaAdditionsByTrappModElements instance) {
		super(instance, 205);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("vanilla_additions_by_trapp:faestone_match"),
			...
			event.getRegistry().register(feature.setRegistryName("faestone"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("vanilla_additions_by_trapp:faestone"), configuredFeature);
		}
	}
	@SubscribeEvent
