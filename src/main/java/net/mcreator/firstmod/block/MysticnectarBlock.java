...
import net.mcreator.firstmod.procedures.MysticnectarMobplayerCollidesBlockProcedure;
...
public class MysticnectarBlock extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:mysticnectar")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("vanilla_additions_by_trapp:mysticnectar_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public MysticnectarBlock(VanillaAdditionsByTrappModElements instance) {
		super(instance, 203);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				CustomFluidAttributes
						.builder(new ResourceLocation("vanilla_additions_by_trapp:blocks/juice3"),
								new ResourceLocation("vanilla_additions_by_trapp:blocks/juiceflow3"))
						.luminosity(7).density(983).viscosity(963).temperature(280).rarity(Rarity.COMMON).color(-13083194)).explosionResistance(100f)
								.canMultiply().tickRate(4).levelDecreasePerBlock(1).slopeFindDistance(4).bucket(() -> bucket).block(() -> block);
		still = (FlowingFluid) new CustomFlowingFluid.Source(fluidproperties).setRegistryName("mysticnectar");
		flowing = (FlowingFluid) new CustomFlowingFluid.Flowing(fluidproperties).setRegistryName("mysticnectar_flowing");
		elements.blocks
				.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.WATER).hardnessAndResistance(100f).setLightLevel(s -> 7)) {
					@Override
					...
					public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
						...
						int z = pos.getZ();
						{
							...
							MysticnectarMobplayerCollidesBlockProcedure.executeProcedure($_dependencies);
						}
					}
				}.setRegistryName("mysticnectar"));
		elements.items.add(() -> new BucketItem(still,
				new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ItemGroup.MISC).rarity(Rarity.COMMON))
						.setRegistryName("mysticnectar_bucket"));
	}
	public static abstract class CustomFlowingFluid extends ForgeFlowingFluid {
		...
		public Vector3d getFlow(IBlockReader world, BlockPos pos, FluidState fluidstate) {
			return super.getFlow(world, pos, fluidstate).scale(1.2000000000000002);
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("mysticnectar_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("vanilla_additions_by_trapp:mysticnectar_lakes"),
					configuredFeature);
		}
	}
	@SubscribeEvent
