...
public class NoxitereactorBlock extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:noxitereactor")
	public static final Block block = null;
	public NoxitereactorBlock(VanillaAdditionsByTrappModElements instance) {
		super(instance, 216);
	}
