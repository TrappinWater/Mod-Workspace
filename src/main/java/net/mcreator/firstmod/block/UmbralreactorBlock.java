...
public class UmbralreactorBlock extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:umbralreactor")
	public static final Block block = null;
	public UmbralreactorBlock(VanillaAdditionsByTrappModElements instance) {
		super(instance, 318);
	}
