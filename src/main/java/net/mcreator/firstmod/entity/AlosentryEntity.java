...
import net.mcreator.firstmod.entity.renderer.AlosentryRenderer;
...
public class AlosentryEntity extends VanillaAdditionsByTrappModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.7999999999999998f)).build("alosentry").setRegistryName("alosentry");
	public AlosentryEntity(VanillaAdditionsByTrappModElements instance) {
		super(instance, 373);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AlosentryRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -6710887, -52429, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("alosentry_spawn_egg"));
	}
