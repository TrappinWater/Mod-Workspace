...
import net.mcreator.firstmod.entity.renderer.AngrypixieRenderer;
...
public class AngrypixieEntity extends VanillaAdditionsByTrappModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("angrypixie").setRegistryName("angrypixie");
	public AngrypixieEntity(VanillaAdditionsByTrappModElements instance) {
		super(instance, 302);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AngrypixieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("angrypixie_spawn_egg"));
	}
