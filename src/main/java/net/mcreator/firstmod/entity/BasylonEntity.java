...
import net.mcreator.firstmod.procedures.BasylonEntityIsHurtProcedure;
import net.mcreator.firstmod.entity.renderer.BasylonRenderer;
...
public class BasylonEntity extends VanillaAdditionsByTrappModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1f, 4.5f)).build("basylon").setRegistryName("basylon");
	public BasylonEntity(VanillaAdditionsByTrappModElements instance) {
		super(instance, 377);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BasylonRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("basylon_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				BasylonEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
