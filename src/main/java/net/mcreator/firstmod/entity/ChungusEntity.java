...
public class ChungusEntity extends VanillaAdditionsByTrappModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1.6f, 2.9f)).build("chungus").setRegistryName("chungus");
	public ChungusEntity(VanillaAdditionsByTrappModElements instance) {
		super(instance, 150);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ChungusRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -10066330, -65485, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("chungus_spawn_egg"));
	}
