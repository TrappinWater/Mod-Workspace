...
import net.mcreator.firstmod.procedures.EyeEntityIsHurtProcedure;
import net.mcreator.firstmod.item.EyeshotItem;
import net.mcreator.firstmod.entity.renderer.EyeRenderer;
...
public class EyeEntity extends VanillaAdditionsByTrappModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.9f, 2.8000000000000003f)).build("eye").setRegistryName("eye");
	public EyeEntity(VanillaAdditionsByTrappModElements instance) {
		super(instance, 344);
		FMLJavaModLoadingContext.get().getModEventBus().register(new EyeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -52, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("eye_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ARMOR, 24);
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				EyeEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
