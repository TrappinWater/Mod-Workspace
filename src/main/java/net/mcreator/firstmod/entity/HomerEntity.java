...
import net.mcreator.firstmod.procedures.HomerOnEntityTickUpdateProcedure;
import net.mcreator.firstmod.procedures.HomerEntityDiesProcedure;
import net.mcreator.firstmod.entity.renderer.HomerRenderer;
...
public class HomerEntity extends VanillaAdditionsByTrappModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1f, 1f)).build("homer").setRegistryName("homer");
	public HomerEntity(VanillaAdditionsByTrappModElements instance) {
		super(instance, 147);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				HomerEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				HomerOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
