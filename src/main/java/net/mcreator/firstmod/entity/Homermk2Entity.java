...
import net.mcreator.firstmod.procedures.Homermk2PlayerCollidesWithThisEntityProcedure;
import net.mcreator.firstmod.procedures.Homermk2OnEntityTickUpdateProcedure;
import net.mcreator.firstmod.item.SpicelauncherItem;
import net.mcreator.firstmod.entity.renderer.Homermk2Renderer;
...
public class Homermk2Entity extends VanillaAdditionsByTrappModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.5f, 0.5f)).build("homermk_2").setRegistryName("homermk_2");
	public Homermk2Entity(VanillaAdditionsByTrappModElements instance) {
		super(instance, 309);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Homermk2Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -52429, -3407821, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("homermk_2_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				Homermk2OnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				Homermk2PlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}

		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			SpicelauncherItem.shoot(this, target);
		}
