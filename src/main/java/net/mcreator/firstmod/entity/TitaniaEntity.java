...
import net.mcreator.firstmod.procedures.TitaniaEntityIsHurtProcedure;
import net.mcreator.firstmod.item.StaffoftheearthItem;
import net.mcreator.firstmod.entity.renderer.TitaniaRenderer;
...
public class TitaniaEntity extends VanillaAdditionsByTrappModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.5999999999999999f, 2.5f)).build("titania").setRegistryName("titania");
	public TitaniaEntity(VanillaAdditionsByTrappModElements instance) {
		super(instance, 301);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TitaniaRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -16738048, -65434, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("titania_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				TitaniaEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
			return super.attackEntityFrom(source, amount);
		}

		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			StaffoftheearthItem.shoot(this, target);
		}
