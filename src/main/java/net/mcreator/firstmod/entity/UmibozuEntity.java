...
import net.mcreator.firstmod.entity.renderer.UmibozuRenderer;
...
public class UmibozuEntity extends VanillaAdditionsByTrappModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(2.6999999999999997f, 3.5f)).build("umibozu").setRegistryName("umibozu");
	public UmibozuEntity(VanillaAdditionsByTrappModElements instance) {
		super(instance, 383);
		FMLJavaModLoadingContext.get().getModEventBus().register(new UmibozuRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -16764007, -13312, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("umibozu_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MAX_HEALTH, 180);
			ammma = ammma.createMutableAttribute(Attributes.ARMOR, 0);
			ammma = ammma.createMutableAttribute(Attributes.ATTACK_DAMAGE, 15);
			ammma = ammma.createMutableAttribute(Attributes.KNOCKBACK_RESISTANCE, 10.7);
			ammma = ammma.createMutableAttribute(Attributes.ATTACK_KNOCKBACK, 5.1000000000000005);
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			WatershotItem.shoot(this, target);
		}
