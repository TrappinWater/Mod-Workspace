...
@OnlyIn(Dist.CLIENT)
public class ArdomRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ArdomEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelgemini(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("vanilla_additions_by_trapp:textures/gemini1.png");
					}
				};
			});
		}
