...
@OnlyIn(Dist.CLIENT)
public class BasylonRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BasylonEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelbasylon(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("vanilla_additions_by_trapp:textures/basylon.png");
					}
				};
			});
		}
