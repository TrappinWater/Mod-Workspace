...
@OnlyIn(Dist.CLIENT)
public class MalformedRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(MalformedEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelmalformed(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("vanilla_additions_by_trapp:textures/malformed.png");
					}
				};
			});
		}
