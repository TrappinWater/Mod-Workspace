...
public class AlostoneItem extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:alostone")
	public static final Item block = null;
	public AlostoneItem(VanillaAdditionsByTrappModElements instance) {
		super(instance, 277);
	}
