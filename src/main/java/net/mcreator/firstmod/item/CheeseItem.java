...
public class CheeseItem extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:cheese")
	public static final Item block = null;
	public CheeseItem(VanillaAdditionsByTrappModElements instance) {
		super(instance, 281);
	}
