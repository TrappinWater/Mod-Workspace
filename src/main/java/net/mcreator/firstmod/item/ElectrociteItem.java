...
public class ElectrociteItem extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:electrocite")
	public static final Item block = null;
	public ElectrociteItem(VanillaAdditionsByTrappModElements instance) {
		super(instance, 245);
	}
