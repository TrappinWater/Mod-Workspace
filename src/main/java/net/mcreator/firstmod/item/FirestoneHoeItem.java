...
public class FirestoneHoeItem extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:firestone_hoe")
	public static final Item block = null;
	public FirestoneHoeItem(VanillaAdditionsByTrappModElements instance) {
		super(instance, 33);
	}
