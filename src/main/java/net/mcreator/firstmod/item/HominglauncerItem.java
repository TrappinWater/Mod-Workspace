...
import net.mcreator.firstmod.procedures.HominglauncerRangedItemUsedProcedure;
import net.mcreator.firstmod.entity.renderer.HominglauncerRenderer;
...
public class HominglauncerItem extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:hominglauncer")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybullethominglauncer").setRegistryName("entitybullethominglauncer");
	public HominglauncerItem(VanillaAdditionsByTrappModElements instance) {
		super(instance, 149);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HominglauncerRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1.2f, 1, 2);
					...
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						...
						HominglauncerRangedItemUsedProcedure.executeProcedure($_dependencies);
					}
				}
			}
		}
