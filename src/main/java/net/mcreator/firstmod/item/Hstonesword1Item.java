...
public class Hstonesword1Item extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:hstonesword_1")
	public static final Item block = null;
	public Hstonesword1Item(VanillaAdditionsByTrappModElements instance) {
		super(instance, 396);
	}
