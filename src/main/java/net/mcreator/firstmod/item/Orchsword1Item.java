...
public class Orchsword1Item extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:orchsword_1")
	public static final Item block = null;
	public Orchsword1Item(VanillaAdditionsByTrappModElements instance) {
		super(instance, 399);
	}
