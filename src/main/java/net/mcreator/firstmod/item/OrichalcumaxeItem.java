...
public class OrichalcumaxeItem extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:orichalcumaxe")
	public static final Item block = null;
	public OrichalcumaxeItem(VanillaAdditionsByTrappModElements instance) {
		super(instance, 233);
	}
