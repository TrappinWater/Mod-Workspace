...
public class OrichalcumhoeItem extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:orichalcumhoe")
	public static final Item block = null;
	public OrichalcumhoeItem(VanillaAdditionsByTrappModElements instance) {
		super(instance, 236);
	}
