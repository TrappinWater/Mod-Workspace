...
public class SkystoneAxeItem extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:skystone_axe")
	public static final Item block = null;
	public SkystoneAxeItem(VanillaAdditionsByTrappModElements instance) {
		super(instance, 76);
	}
