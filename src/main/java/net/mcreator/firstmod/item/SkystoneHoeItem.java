...
public class SkystoneHoeItem extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:skystone_hoe")
	public static final Item block = null;
	public SkystoneHoeItem(VanillaAdditionsByTrappModElements instance) {
		super(instance, 79);
	}
