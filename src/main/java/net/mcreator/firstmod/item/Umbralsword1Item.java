...
public class Umbralsword1Item extends VanillaAdditionsByTrappModElements.ModElement {
	@ObjectHolder("vanilla_additions_by_trapp:umbralsword_1")
	public static final Item block = null;
	public Umbralsword1Item(VanillaAdditionsByTrappModElements instance) {
		super(instance, 398);
	}
