...
public class DarkrotseaBiome extends VanillaAdditionsByTrappModElements.ModElement {
	public static Biome biome;
	public DarkrotseaBiome(VanillaAdditionsByTrappModElements instance) {
		super(instance, 210);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16777165).setWaterColor(-16764109).setWaterFogColor(-16764109)
						.withSkyColor(-16777165).withFoliageColor(10387789).withGrassColor(-16764109)
						.setParticle(new ParticleEffectAmbience(ParticleTypes.FALLING_WATER, 0.004f)).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.SEAGRASS
						.withConfiguration(new ProbabilityConfig(0.3F)).func_242731_b(23).withPlacement(Features.Placements.SEAGRASS_DISK_PLACEMENT));
				...
				event.getRegistry().register(biome.setRegistryName("vanilla_additions_by_trapp:darkrotsea"));
			}
		}
	}
	@Override
