...
public class FaeplainsBiome extends VanillaAdditionsByTrappModElements.ModElement {
	public static Biome biome;
	public FaeplainsBiome(VanillaAdditionsByTrappModElements instance) {
		super(instance, 204);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-26113).setWaterColor(-39373).setWaterFogColor(-39373)
						.withSkyColor(-26113).withFoliageColor(-13369447).withGrassColor(-39373)
						.setParticle(new ParticleEffectAmbience(ParticleTypes.CRIMSON_SPORE, 0.006f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(EnchantedgrassBlock.block.getDefaultState(),
								FaestoneBlock.block.getDefaultState(), FaestoneBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("vanilla_additions_by_trapp:faeplains"));
			}
		}
	}
	@Override
